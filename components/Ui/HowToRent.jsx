    ...
    <div className="flex flex-col items-center justify-center w-full h-full p-2 gap-2 bg-default">
      ...
      <div className="flex flex-row items-center justify-evenly w-full h-full p-2 gap-2">
        ...
        <Link
          ...
          target="_blank"
          className="flex items-center justify-center min-w-38 min-h-38 lg:min-w-40 lg:min-h-40 p-2 gap-2 rounded-3xl bg-white shadow-md animate-bounce cursor-pointer"
        >
          <Image
