  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full gap-2">
      ...
      <div className="flex items-center justify-center w-full min-h-[500px] p-2 gap-2 border-2 border-dark border-dashed bg-default rounded-[40px]">
        <div className="w-full h-full p-2 border-2 border-dark border-dashed">
          <Swiper
            modules={[Autoplay]}
          ...
          >
            {["1", "2", "3", "4", "5", "6", "7", "8", "9"].map((num) => (
              <SwiperSlide key={num}>
                <div className="w-full h-full p-2 bg-white rounded-3xl shadow-md border-2 border-dark border-dashed relative">
                  <Image
