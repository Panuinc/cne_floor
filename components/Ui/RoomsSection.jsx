      ...
      <div className="flex flex-col lg:flex-row items-center justify-center w-full lg:w-11/12 h-full p-4 gap-2 bg-white rounded-tl-3xl rounded-tr-3xl">
        <div className="flex flex-col lg:flex-row items-start justify-center w-full h-full p-2 gap-2">
          ...
          <div className="flex flex-col items-center justify-center w-full lg:w-8/12 h-full p-2 gap-2">
            <div className="flex flex-col items-end justify-center w-full h-full">
              ...
              <div className="flex items-center justify-center h-full p-2 gap-2 bg-white shadow-md rounded-bl-lg rounded-br-lg text-lg font-[600]">
                {t("dividedOffice")}
              </div>
            </div>
            {["room201", "room202"].map((key) => (
              <div
                key={key}
                className="relative flex items-center justify-center w-full h-full p-2 gap-2 border-2 border-green-400 bg-green-50 text-lg font-[600] rounded-lg"
              >
            ...
            <div className="relative flex items-center justify-start w-full h-full p-4 gap-2 border-2 border-red-400 bg-red-50 text-lg font-[600] rounded-lg">
              ❌ {t("room203")}
        ...
        <div className="flex flex-col lg:flex-row items-start justify-center w-full h-full p-2 gap-2">
          <div className="flex flex-col items-center justify-center w-full lg:w-8/12 h-full p-2 gap-2">
            ...
            <div className="relative flex items-center justify-center w-full h-full p-2 gap-2 border-2 border-green-400 bg-green-50 text-lg font-[600] rounded-lg">
              <span className="flex items-center justify-start w-full h-full p-2 gap-2">
                ✅ {t("wholeFloorDesc")}
              </span>
            </div>
